...
def asymmetry_detection(flight_data=None, error=0.01, save_csv=True, save_txt=True,
    ...
    if save_csv :
        ...
        write_in_csv(out_path_channel, anomalies_channel_couples_names, anomalies_relative_length_channel_couples, anomalies_channel_reg_coef)    
        write_in_csv(out_path_lat, anomalies_lat_couples_names, anomalies_relative_length_lat_couples, anomalies_lat_reg_coef)    
    ...
    if save_txt :
        ...
        write_in_file(out_path_txt, flight_name, anomalies_channel_couples_names, anomalies_relative_length_channel_couples, anomalies_channel_reg_coef,error, 1)    
        write_in_file(out_path_txt, flight_name, anomalies_lat_couples_names, anomalies_relative_length_lat_couples, anomalies_lat_reg_coef,error, 0) 
